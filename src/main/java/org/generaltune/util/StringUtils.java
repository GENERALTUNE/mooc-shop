...
public class StringUtils extends org.apache.commons.lang.StringUtils {
     ...
     * @param source
     *
     * @return 检查内容是否能够匹配正则条件
     */
    public static boolean regexMatch(String regex, String source) {
        try {
            ...
            System.out.print("[regexMatch]:[" + regex + ":" + source + "]:" + e.getMessage());
        }
        return false;
    }
     ...
     * @return 结果字符串
     */
    public static String trimSBCSpace(String src) {
        if(src == null) {
            return null;
        }
