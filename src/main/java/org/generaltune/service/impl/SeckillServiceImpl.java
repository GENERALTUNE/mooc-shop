...
import org.generaltune.dao.SeckillDao;
import org.generaltune.dao.SuccessKilledDao;
...
public class SeckillServiceImpl implements SeckillService {
     ...
     * 3: 不是所有的方法都需要事务，如只有一条修改操作，只读操作不需要事务控制。mysql的行级锁
     */
    ...
    public int insertSeckill(Seckill seckill) {
        int result = seckillDao.insertSeckill(seckill.getName(), seckill.getNumber(),seckill.getStartTime(), seckill.getEndTime());
        return result;
    }
}
